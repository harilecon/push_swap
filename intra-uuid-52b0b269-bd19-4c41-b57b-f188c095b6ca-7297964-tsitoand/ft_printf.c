...
/*   Updated: 2026/02/14 13:00:53 by tsitoand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (s[i] != '%')
		return (ft_printf_char(s[i]));
	else if (((s[i + 1] == 'd')) || (s[i + 1] == 'i'))
		return (ft_printf_int_nb(va_arg(args, int)));
	else if (s[i + 1] == 'x')
		return (ft_printf_int_hexlow(va_arg(args, unsigned int)));
	else if (s[i + 1] == 'X')
		return (ft_printf_int_hexup(va_arg(args, unsigned int)));
	else if (s[i + 1] == 'u')
		return (ft_printf_unsigned_int_nb(va_arg(args, unsigned int)));
	else if (s[i + 1] == 'p')
		return (ft_printf_address(va_arg(args, void *)));
	else if (s[i + 1] == 's')
